...
export const StartBlock = withMenuComponentBlock({
  ...
  Component: () => <>
    <div className='columns'>
      ...
      <div className='column is-3 has-text-centered is-size-3-desktop is-size-4-touch'>
    ...
    <div className='columns'>
      ...
      <div className='brand-name column is-4 has-text-left-desktop has-text-centered-mobile is-size-3-desktop is-size-4-touch'>
        <span className='brand-red-underline-white'>Lerne</span>
        <span className='brand-name-500-white'> die Kampfkünste der Samurai und ihre moderne Anwendung</span>
      </div>
      <div className='column is-7' />
    </div>
  </>,
